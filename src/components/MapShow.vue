...
// import VotesTooltip from './VotesTooltip.vue';
        ...
        <div class="p-3">
          ...
          <ul v-if="hoverCountyVotesInfo" class="mt-7">
            <li class="flex justify-between items-center py-1">
              ...
              <p class="w-5/12 ml-1 text-center">蔡英文<br />得票率</p>
            ...
            <li class="flex justify-between items-center py-1">
              <div class="w-2/12">
                <img src="src/assets/images/blueCirclePortrait.png" alt="蔡英文圓形肖像" width="42"/>
              </div>
              <p class="w-5/12 ml-1 text-center">韓國瑜<br />得票率</p>
            ...
            <li class="flex justify-between items-center py-1">
              <div class="w-2/12">
                <img src="src/assets/images/orangeCirclePortrait.png" alt="蔡英文圓形肖像" width="42"/>
              </div>
              <p class="w-5/12 ml-1 text-center">宋楚瑜<br />得票率</p>
...
<template>
  ...
  <div class="overflow-hidden relative">
    ...
    <div class="absolute top-3 right-3">
      ...
      <div class="flex">
        <div class="w-6 h-5 bg-orange-300"></div>
        <div class="w-6 h-5 bg-orange-400"></div>
        <div class="w-6 h-5 bg-orange-500"></div>
      </div>
    </div>
  </div>
</template>
